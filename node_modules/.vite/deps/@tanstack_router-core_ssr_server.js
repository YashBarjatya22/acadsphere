...
import {
  dehydrateSsrMatchId,
  mergeHeaders
} from "./chunk-UIMD4F6K.js";
import {
  decodePath,
  invariant
} from "./chunk-DFWESH7U.js";
...
function transformPipeableStreamWithRouter(router, routerStream, opts) {
  return import_node_stream.Readable.fromWeb(transformStreamWithRouter(router, import_node_stream.Readable.toWeb(routerStream), opts));
}
