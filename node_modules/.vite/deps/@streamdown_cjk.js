...
// node_modules/micromark-extension-cjk-friendly-gfm-strikethrough/dist/strikethrough.js
...
// node_modules/remark-cjk-friendly-gfm-strikethrough/dist/index.js
...
// node_modules/@streamdown/cjk/dist/index.js
...
var p = (t, r) => ({ ...r, url: t, children: [{ type: "text", value: t }] });
var d = (t) => ({ type: "text", value: t });
var y = () => (t) => {
  visit(t, "link", (r, e, i) => {
...
function b() {
  let t = [remarkCjkFriendly], r = [y, remarkGfmStrikethroughCjkFriendly], e = [...t, ...r];
  return { name: "cjk", type: "cjk", remarkPluginsBefore: t, remarkPluginsAfter: r, remarkPlugins: e };
}
var A = b();
export {
  A as cjk,
  b as createCjkPlugin
};
//# sourceMappingURL=@streamdown_cjk.js.map
