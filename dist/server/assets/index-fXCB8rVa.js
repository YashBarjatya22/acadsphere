...
import { l as localDemoLogin } from "./auth.functions-D1i0e8hB.js";
import { toast } from "sonner";
import { Sun, Moon, ArrowRight, LayoutDashboard, Sparkles, BookOpen, Code, FileCheck2, CheckCircle2, Users, User, Settings, Loader2, Zap, LogIn } from "lucide-react";
...
const FEATURES = [{
  ...
  icon: BookOpen,
  title: "Smart Notes",
  desc: "AI-powered notes with auto-summarisation, keyword highlights, and topic clustering."
}, {
  icon: Code,
  title: "Lab Helper",
  desc: "Lab schedule reminders, experiment walkthroughs, AI code generators, and completion trackers."
}, {
  icon: FileCheck2,
  title: "Resume Builder",
  desc: "ATS score optimisation, placement gap suggestions, and bullet-point editing."
}, {
  icon: CheckCircle2,
  title: "Attendance Tracker",
  desc: "Real-time attendance percentage, subject-wise risk flags, and bunk budget calculator."
}, {
  icon: Users,
  title: "Community",
