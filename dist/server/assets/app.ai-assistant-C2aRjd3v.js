...
import { C as ChatLayout, l as listThreads, g as getThreadMessages, c as createThread, s as saveMessage, d as deleteThread, r as renameThread } from "./ChatLayout-DhDUl__k.js";
import { a as generateAcademicResponse } from "./router-XYZO7mbM.js";
...
const ScrollBar = React.forwardRef(({ className, orientation = "vertical", ...props }, ref) => /* @__PURE__ */ jsx(
  ScrollAreaPrimitive.ScrollAreaScrollbar,
  {
    ...
    children: /* @__PURE__ */ jsx(
      ...
      {
        className: "relative flex-1 rounded-full bg-border hover:bg-muted-foreground transition-colors duration-[120ms]"
      }
    )
  }
));
ScrollBar.displayName = ScrollAreaPrimitive.ScrollAreaScrollbar.displayName;
const AiResponseWriter = ({ text, className, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(ScrollArea, { ref: scrollAreaRef, className: cn("w-full", className), ...props, children: /* @__PURE__ */ jsx("div", { className: "pr-4", children: /* @__PURE__ */ jsx("p", { className: "text-foreground/80 text-sm whitespace-pre-line leading-relaxed", children: text }) }) });
};
const TEMPLATES = [{
  icon: BookOpen,
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 flex flex-col min-w-0 overflow-hidden bg-background", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto scrollbar-thin", children: messagesLoading ? /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 text-muted-foreground animate-spin" }) }) : messages.length === 0 && !streamingContent ? (
        ...
        /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto px-4 py-6 space-y-6", children: [
          ...
          streamingId && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
            ...
            streamingContent ? (
              ...
              /* @__PURE__ */ jsxs("div", { className: "max-w-[85%] w-full bg-card border border-border text-foreground rounded-2xl rounded-tl-sm p-4 shadow-sm ring-1 ring-primary/10", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2 pb-2 border-b border-border/50", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-foreground", children: "AI is responding…" })
                ] }),
                /* @__PURE__ */ jsx(AiResponseWriter, { text: streamingContent, className: "max-h-72" })
              ] })
            ) : (
