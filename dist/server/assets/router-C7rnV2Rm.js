...
const appCss = "/assets/styles-CxgSG5Yw.css";
...
const $$splitComponentImporter$A = () => import("./auth-BjxUbYJ2.js");
...
const $$splitComponentImporter$z = () => import("./route-QNAbDGWW.js");
...
const $$splitComponentImporter$y = () => import("./route-COGOA2qP.js");
...
const $$splitComponentImporter$x = () => import("./index-fXCB8rVa.js");
...
const $$splitComponentImporter$w = () => import("./index-DSirLG8w.js");
const Route$x = createFileRoute("/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./auth.callback-DWfwg_cE.js");
...
const Route$v = createFileRoute("/api/chat")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let messages = [];
...
const $$splitComponentImporter$u = () => import("./users-CtOe9rEl.js");
const Route$u = createFileRoute("/admin/users")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./students-BmuztjVw.js");
const Route$t = createFileRoute("/admin/students")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./settings-BoE3HdKD.js");
const Route$s = createFileRoute("/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./security-C14F-52a.js");
const Route$r = createFileRoute("/admin/security")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./roles-Dg6HghN8.js");
const Route$q = createFileRoute("/admin/roles")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("./reports-B4WpnhaB.js");
const Route$p = createFileRoute("/admin/reports")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./notes-monitoring-DYWcLSSZ.js");
const Route$o = createFileRoute("/admin/notes-monitoring")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./live-activity-BVkuZ4p8.js");
const Route$n = createFileRoute("/admin/live-activity")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./audit-logs-2TFAf2Jj.js");
const Route$m = createFileRoute("/admin/audit-logs")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./announcements-Cy9WZK6b.js");
const Route$l = createFileRoute("/admin/announcements")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./analytics-D5vSFFPa.js");
const Route$k = createFileRoute("/admin/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./academic-monitoring-MyFrlFCj.js");
const Route$j = createFileRoute("/admin/academic-monitoring")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./paper-simplifier-BY8cgkHp.js");
const Route$i = createFileRoute("/_authenticated/paper-simplifier")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./notes-gap-analyzer-DBwkyCye.js");
const Route$h = createFileRoute("/_authenticated/notes-gap-analyzer")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./app.index-CwdkvzO3.js");
const Route$g = createFileRoute("/_authenticated/app/")({
  beforeLoad: async () => {
    if (typeof window !== "undefined") {
...
const $$splitComponentImporter$f = () => import("./app.students-D04gVA0a.js");
const Route$f = createFileRoute("/_authenticated/app/students")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./app.settings-l4MIH2p0.js");
const Route$e = createFileRoute("/_authenticated/app/settings")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./app.resume-analyzer-CsEmJFyA.js");
const Route$d = createFileRoute("/_authenticated/app/resume-analyzer")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./app.profile-ARP83Z2r.js");
const Route$c = createFileRoute("/_authenticated/app/profile")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./app.notes-Cq2ZpPyO.js");
const Route$b = createFileRoute("/_authenticated/app/notes")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./app.lab-buddy-CMAma2Oc.js");
const Route$a = createFileRoute("/_authenticated/app/lab-buddy")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./app.extra-Bhe5Zvf-.js");
const Route$9 = createFileRoute("/_authenticated/app/extra")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./app.conversions-DsMVkOM5.js");
const Route$8 = createFileRoute("/_authenticated/app/conversions")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./app.community-Di7D2Nz6.js");
const Route$7 = createFileRoute("/_authenticated/app/community")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./app.classroom-CSpBZ7v7.js");
...
const $$splitComponentImporter$5 = () => import("./app.career-roadmap-CPI_lXPr.js");
const Route$5 = createFileRoute("/_authenticated/app/career-roadmap")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./app.attendance-BqGwt0N8.js");
const Route$4 = createFileRoute("/_authenticated/app/attendance")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./app.assignments-CT7R5BaG.js");
const Route$3 = createFileRoute("/_authenticated/app/assignments")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./app.announcements-BDYyLpcb.js");
const Route$2 = createFileRoute("/_authenticated/app/announcements")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./app.ai-assistant-B0i1Ywq9.js");
const Route$1 = createFileRoute("/_authenticated/app/ai-assistant")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./app._threadId-BVsul_Ra.js");
...
const ApiChatRoute = Route$v.update({
  id: "/api/chat",
  path: "/api/chat",
  getParentRoute: () => Route$D
});
const AdminUsersRoute = Route$u.update({
  id: "/users",
  path: "/users",
  getParentRoute: () => AdminRouteRoute
});
const AdminStudentsRoute = Route$t.update({
  id: "/students",
  path: "/students",
  getParentRoute: () => AdminRouteRoute
});
const AdminSettingsRoute = Route$s.update({
  id: "/settings",
  path: "/settings",
  getParentRoute: () => AdminRouteRoute
});
const AdminSecurityRoute = Route$r.update({
  id: "/security",
  path: "/security",
  getParentRoute: () => AdminRouteRoute
});
const AdminRolesRoute = Route$q.update({
  id: "/roles",
  path: "/roles",
  getParentRoute: () => AdminRouteRoute
});
const AdminReportsRoute = Route$p.update({
  id: "/reports",
  path: "/reports",
  getParentRoute: () => AdminRouteRoute
});
const AdminNotesMonitoringRoute = Route$o.update({
  id: "/notes-monitoring",
  path: "/notes-monitoring",
  getParentRoute: () => AdminRouteRoute
});
const AdminLiveActivityRoute = Route$n.update({
  id: "/live-activity",
  path: "/live-activity",
  getParentRoute: () => AdminRouteRoute
});
const AdminAuditLogsRoute = Route$m.update({
  id: "/audit-logs",
  path: "/audit-logs",
  getParentRoute: () => AdminRouteRoute
});
const AdminAnnouncementsRoute = Route$l.update({
  id: "/announcements",
  path: "/announcements",
  getParentRoute: () => AdminRouteRoute
});
const AdminAnalyticsRoute = Route$k.update({
  id: "/analytics",
  path: "/analytics",
  getParentRoute: () => AdminRouteRoute
});
const AdminAcademicMonitoringRoute = Route$j.update({
  id: "/academic-monitoring",
  path: "/academic-monitoring",
  getParentRoute: () => AdminRouteRoute
});
const AuthenticatedPaperSimplifierRoute = Route$i.update({
  id: "/paper-simplifier",
  path: "/paper-simplifier",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedNotesGapAnalyzerRoute = Route$h.update({
  id: "/notes-gap-analyzer",
  path: "/notes-gap-analyzer",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAppIndexRoute = Route$g.update({
  id: "/app/",
  path: "/app/",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAppStudentsRoute = Route$f.update({
  id: "/app/students",
  path: "/app/students",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAppSettingsRoute = Route$e.update({
  id: "/app/settings",
  path: "/app/settings",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAppResumeAnalyzerRoute = Route$d.update({
  id: "/app/resume-analyzer",
  path: "/app/resume-analyzer",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAppProfileRoute = Route$c.update({
  id: "/app/profile",
  path: "/app/profile",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAppNotesRoute = Route$b.update({
  id: "/app/notes",
  path: "/app/notes",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAppLabBuddyRoute = Route$a.update({
  id: "/app/lab-buddy",
  path: "/app/lab-buddy",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedRouteRouteChildren = {
  AuthenticatedNotesGapAnalyzerRoute,
  ...
  AuthenticatedAppLabBuddyRoute,
  AuthenticatedAppNotesRoute,
