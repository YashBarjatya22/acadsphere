...
import { c as createSsrRpc, u as useServerFn } from "./createSsrRpc-B5NaTOOc.js";
...
import { GraduationCap, Wifi, RefreshCw, Send, MessageSquare, Sparkles, Info, X, AlertTriangle, Clock, CheckCircle2, BookOpen, ChevronDown, Search, Calendar, ExternalLink, Check } from "lucide-react";
...
function ClassroomPage() {
  ...
  const {
    ...
    // Show cache immediately while GCR loads
  });
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      toast.error("Sync failed", {
        description: err?.message || "Could not reach Google Classroom."
      });
    } finally {
  ...
  return /* @__PURE__ */ jsx(ChatLayout, { activeThreadId: null, children: /* @__PURE__ */ jsxs("div", { className: "h-full overflow-y-auto bg-[#FAFAF8] dark:bg-background text-[#0A0A0A] dark:text-foreground p-4 md:p-8 space-y-6 scrollbar-thin", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#E0DDD4] pb-5", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [
          ...
          isBackgroundRefreshing ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-amber-500/10 text-amber-700 border border-amber-300/40 whitespace-nowrap shrink-0 animate-pulse", children: [
            /* @__PURE__ */ jsx(Wifi, { className: "h-2.5 w-2.5" }),
            "Syncing live…"
          ] }) : isConnected ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-500/10 text-emerald-700 border border-emerald-300/40 whitespace-nowrap shrink-0", children: [
            /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 inline-block" }),
            "Live"
          ] }) : isShowingCache ? /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-blue-500/10 text-blue-700 border border-blue-300/40 whitespace-nowrap shrink-0", children: "Cached" }) : null
        ] })
      ] }),
    ...
    !isConnected && showBanner && /* @__PURE__ */ jsx("div", { className: "relative rounded-2xl border border-amber-300/60 bg-amber-500/10 p-4 md:p-5 shadow-sm transition-all duration-200", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3.5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-800/80 dark:text-amber-300/80 leading-relaxed mt-0.5 max-w-2xl", children: isShowingCache ? "Showing your last synced assignments. Connect to load live deadlines and grades." : "Sync your live university assignments, deadlines, and grades from Google Classroom." }),
    ...
    isLoading ? (
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16 px-4 bg-[#F4F2EC] rounded-2xl border border-[#E0DDD4] text-center", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-[#0A0A0A]", children: !isConnected && !isShowingCache ? "Connect Google Classroom" : "You're all caught up!" }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1 max-w-sm", children: !isConnected && !isShowingCache ? "Authorize your Google account above to load your live coursework and deadlines." : searchQuery || selectedCourse !== "ALL" || activeTab !== "ALL" ? "No submissions match your selected filter criteria." : "No pending or overdue assignments found across your Classroom subjects." })
      ] })
    ) : (
      /* Cards Grid */
        ...
        return /* @__PURE__ */ jsx("div", { className: `group relative rounded-2xl border p-5 bg-[#F4F2EC] transition-all duration-150 hover:shadow-md ${isOverdue ? "border-red-300 dark:border-red-900/50" : isReviewed ? "opacity-60 border-[#E0DDD4]" : "border-[#E0DDD4] hover:border-[#0A0A0A]/30"}`, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
              ...
              isCacheItem && isBackgroundRefreshing && /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 rounded-full text-[9px] font-semibold bg-[#0A0A0A]/5 text-muted-foreground border border-[#E0DDD4]", children: "cached" })
            ] }),
